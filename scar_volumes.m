...
%sum( meshQuality( tetgen( MeshFillHoles( LV ) ) , 'volume' ) ) %alternative approach to compute the volumetric mesh is by filling the mesh completely with tetrahedra and computing the volume of each one

meshVolume( MeshFillHoles( EPI ) ) - meshVolume( MeshFillHoles( LV ) ) - meshVolume( MeshFillHoles( RV ) ) %different way of getting the muscle mass of both ventricles
